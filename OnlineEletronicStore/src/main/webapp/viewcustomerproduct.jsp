...
out.println("<div class='greeting'>Hello, " + bean.getUname() + "! These are your product details:</div>");

if (al == null || al.size() == 0) {
    out.println("<div class='message'>Product Details are not available.</div>");
} else {
    out.println("<table>");
    out.println("<tr><th>Product Code</th><th>Company</th><th>Name</th><th>Price</th><th>Quantity</th></tr>");
    ...
    while(i.hasNext()) {
        ...
        out.println("<td>" + "<a href='buy?pcode=" + pb.getPcode() + "'>Buy</a>"
        	    + "</td>");
        out.println("</tr>");
    }
    out.println("</table>");
